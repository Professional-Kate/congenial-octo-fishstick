...
namespace IdelPog.Combat.Runtime.Event.Trigger.Handler
{
    public sealed class CombatantDeathHandler : TriggerAbilityHandler<CombatantDeathData>
    {
        ...
        protected override IEnumerable<AbilityTrigger> Filter(ImmutableArray<CombatantAbilityEntity> combatantAbilityEntities, CombatantDeathData triggerData, double tick)
        {
