...
namespace IdelPog.Repository
{
    ...
    {
        /// <summary>
        /// Returns an item from the Repository using its <see cref="CurrencyType"/> type
        /// </summary>
        ...
        /// <remarks>
        /// The returned <see cref="Currency"/> will be passed by reference. So any changes to the returned <see cref="Currency"/> will change that <see cref="Currency"/> in the Repository
        /// </remarks>
