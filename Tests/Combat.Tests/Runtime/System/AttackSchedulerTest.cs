...
namespace IdelPog.Combat.Tests.Runtime.System
{
    ...
    public sealed class AttackSchedulerTest
    {
        ...
        public void OneTimeSetup()
        {
            ...
            _attackScheduler = new AttackScheduler(_combatQueueMock.Object, _damageSystemMock.Object, new NumberAssertion(), _combatantRepositoryMock.Object);

            _attackerStats = new StatCard { Health = 100, Attack = 10, Speed = 10 };
            _combatantEntity = new CombatantEntity(_repositoryAsserter, _attackerStats) { IsFriendly = true };
        }
        ...
        private void SetupRepositoryGet(params CombatantEntity[] combatantEntities)
        { 
        ...
        [Test]
        public void Positive_Enqueue_EnqueuesSingleAttackEvent()
        {
        ...
        [Test]
        public void Positive_Enqueue_EnqueuesMultipleAttackEvent()
        {
            SetupRepositoryGet(_combatantEntity, _combatantEntity, _combatantEntity, _combatantEntity, _combatantEntity);
        ...
        [Test]
        public void Positive_Enqueue_ZeroTick()
        {
            SetupRepositoryGet(_combatantEntity);
        ...
        [Test]
        public void Positive_Enqueue_NoEntities_NoAction()
        {
            SetupRepositoryGet();
        ...
        [Test]
        public void Negative_Enqueue_ZeroSpeed_Throws()
        {
            CombatantEntity zeroSpeedEntity = new(_repositoryAsserter, _attackerStats with { Speed = 0 }) { IsFriendly = true };
            SetupRepositoryGet(zeroSpeedEntity);
