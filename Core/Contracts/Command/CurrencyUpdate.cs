...
namespace IdelPog.Core.Contracts.Command
{
    ...
    {
        /// <summary>
        /// What <see cref="Contracts.Enum.CurrencyType"/> the action should perform on
        /// </summary>
        public required CurrencyType CurrencyType { get; init; }

        /// <summary>
        /// The amount that should be Removed/Added to the <see cref="Contracts.Enum.CurrencyType"/>
        /// </summary>
        /// <remarks>This number should be positive. We do not accept zero</remarks>
        public required uint Amount { get; init; }

        /// <summary>
        /// <inheritdoc cref="Contracts.Enum.ActionType"/>
        /// </summary>
